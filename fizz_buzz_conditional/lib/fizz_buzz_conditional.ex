defmodule FizzBuzzConditional do
  ...
  ## Examples
      ...
      iex> FizzBuzzConditional.fuzzle(0, 0, 4)
      "FizzBuzz"

      iex> FizzBuzzConditional.fuzzle(0, 3, 4)
      "Fizz"

      iex> FizzBuzzConditional.fuzzle(2, 0, 4)
      "Buzz"

      iex> FizzBuzzConditional.fuzzle(3, 7, 4)
      4

  """

  def fuzzle(arg1, arg2, arg3) do
